...
export const FooterServices = [
  { title: "Solutions", services: ['Marketing','Analytics', 'Commerce', 'Insights'] },
  { title: "Support", services: ['Pricing','Documentation', 'Guides', 'API Status'] },
  { title: "Company", services: ['About','Blog', 'Jobs', 'Press', 'Partners'] },
